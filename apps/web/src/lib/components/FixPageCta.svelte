<section class="glass-card rounded-2xl border-t-2 border-brand-400/50 p-8 sm:p-12">
	<div class="text-center">
		<h2 class="text-2xl font-bold tracking-tight sm:text-3xl">
			Fix your Supabase app in under 60 seconds
		</h2>
		<p class="mx-auto mt-4 max-w-xl leading-relaxed text-gray-400">
		...
		<p class="mt-4 text-xs text-gray-500">
			<code class="text-gray-400">npx create-jiobase</code> — deploy your own proxy on Cloudflare Workers
		</p>
	</div>
</section>
